...
const Home = () => {
  ...
  const categorizeToken = (number) => {
    ...
    const FLOWERS = [32, 43, 51, 57, 85, 343, 354, 833, 875, 888];
    const EYES = [
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.footer}>
        <p>Developed by <a className='handle' href='https://twitter.com/fxru_eth'>@fxru_eth</a>. Like the AnomalyChecker? Any donations to help me fund my new MacBook are welcome &rarr; ferdinandveci.eth</p>
      </div>
    </div>
  );
};
